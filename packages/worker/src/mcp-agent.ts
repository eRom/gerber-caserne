...
export class GerberMcp extends McpAgent<Env> {
  ...
  async init() {
    this.server.tool(
      'rag',
      'Recherche semantique cross-projets dans le vault Gemini (FileSearchStore) puis fetch GitHub des docs cites. Retourne un Markdown structure avec sources + contenu integral, pret a etre synthetise. Ideal pour interroger specs, plans, .cave, docs/superpowers de tous les projets indexes.',
      {
