...
effort: medium
background: false
tools: mcp__plugin_gerber_gerber__rag
---
...
1. Appel **unique** `mcp__plugin_gerber_gerber__rag({ question, repo? })`. Scope avec `repo` si tu sais (depuis ta mémoire) qu'un repo précis répond mieux.
