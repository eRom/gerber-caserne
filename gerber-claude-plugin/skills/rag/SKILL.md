...
- **Ne pas appeler `mcp__plugin_gerber_gerber__rag` directement** depuis la session principale — toujours via le subagent. Sinon on perd tout le bénéfice d'isolation du contexte.
