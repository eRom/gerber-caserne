...
## Pointeur lazy dans GEMINI.md

Si `GEMINI.md` n'existe pas → le créer avec uniquement ce bloc.
...
- Ne JAMAIS toucher aux autres sections de GEMINI.md.
...
- GEMINI.md : pointeur lazy configuré
```
